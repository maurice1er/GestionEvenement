 ...
 * @author user
 */
public class DashResumeForm extends javax.swing.JFrame {
    ...
    public DashResumeForm(Utilisateurs user) {
        this.userInfo = user;
        initComponents();
        ie = new EvenementService();
        iu = new UtilisateurService();
    ...
    public void setResumeTable(HashMap<String, List> data, JPanel panel) {
        ...
        StatPanel sp1 = new StatPanel();
        sp1.statFied.setText("events");
        sp1.statValue.setText(String.valueOf(ie.allEvents().size()));
        panel.add(sp1);
        
        StatPanel sp2 = new StatPanel();
        sp2.statFied.setText("users");
        sp2.statValue.setText(String.valueOf(iu.allUsers().size()));
        panel.add(sp2);
        
        List<Utilisateurs> usersActif = new ArrayList<Utilisateurs>();
        ...
        StatPanel sp3 = new StatPanel();
        sp3.statFied.setText("User actif");
        sp3.statValue.setText(String.valueOf(usersActif.size()));
        panel.add(sp3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashResumeForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashResumeForm().setVisible(true);
            }
        });
    }
