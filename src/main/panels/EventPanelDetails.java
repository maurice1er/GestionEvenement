 ...
 * @author user
 */
public class EventPanelDetails extends javax.swing.JPanel {
     ...
     */
    public EventPanelDetails(int id) {
        try {
        ...
        initComponents();
        setFieldsEventDetailsValue(event);
    }

    private void setFieldsEventDetailsValue(Evenements e) {
    ...
    private void initComponents() {
        ...
        jfEventDesc = new javax.swing.JTextArea();
        ...
        jfEventDesc.setColumns(20);
        jfEventDesc.setLineWrap(true);
        jfEventDesc.setRows(5);
        jfEventDesc.setWrapStyleWord(true);
        jScrollPane3.setViewportView(jfEventDesc);
    ...
    private void jfBtnModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jfBtnModifierActionPerformed
        ...
        event.setDescription(jfEventDesc.getText());
        
        Adresses addr = new Adresses();
        addr.setAdresse1(jfEventAdresse1.getText());
        addr.setAdresse2(jfEventAdresse2.getText());
        addr.setVilleId(iv.getVilleByName(jfEventVille.getSelectedItem().toString()));
        
        Adresses adrs = ia.addAdresses(addr); 
        
        event.setAdresseId(adrs);
        
        SimpleDateFormat inputFormatter = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy", Locale.US);
        String dateFinFormat = "";  String dateDebutFormat = "";
     ...
     private void cleanField(){
        jfEventTitle.setText("");
        jfEventDesc.setText("");
      
        jfEventAdresse1.setText("");
        jfEventAdresse2.setText("");
        
    }
    
    
    
    private void updateEvent(Evenements evnt){
    ...
    private javax.swing.JTextArea jfEventDesc;
